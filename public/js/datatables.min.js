 ...
 *   https://datatables.net/download/#bs4/dt-1.10.21/b-1.6.2/b-flash-1.6.2/b-html5-1.6.2/b-print-1.6.2
 *
 * Included libraries:
 *  DataTables 1.10.21, Buttons 1.6.2, Flash export 1.6.2, HTML5 export 1.6.2, Print view 1.6.2
 */
...
(function(f) {
    ...
    q.ext = C = {
        buttons: {},
        classes: {},
        builder: "bs4/dt-1.10.21/b-1.6.2/b-flash-1.6.2/b-html5-1.6.2/b-print-1.6.2",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
...
(function(f) {
    ...
    v.ext.buttons.csvHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            !1 !== f ? (f || (f = l.characterSet || l.charset),
            f && (f = ";charset=" + f)) : f = "";
            c.bom && (a = "﻿" + a);
            B(new Blob([a],{
                type: "text/csv" + f
    ...
    v.ext.buttons.excelHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            var k = b.buttons.exportData(c.exportOptions), p, v, q = function(a) {
                p = e + 1;
                v = r(h, "row", {
                    attr: {
                        r: p
            ...
            f("row:last c", h).attr("s", "2"));
            m.messageBottom && (q([m.messageBottom], e),
            x(e, k.header.length - 1));
            q = r(h, "cols");
    ...
    v.ext.buttons.pdfHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            for (var e = 0, h = d.body.length; e < h; e++)
                l.push(f.map(d.body[e], function(a) {
                    if (null === a || a === w)
                        a = "";
                    return {
                        text: "string" === typeof a ? a : a + "",
            ...
            c.footer && d.footer && l.push(f.map(d.footer, function(a) {
                return {
                    text: "string" === typeof a ? a : a + "",
                    style: "tableFooter"
                }
