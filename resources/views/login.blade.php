...
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet" />
  ...
  <link href="{{ asset('css/nucleo-svg.css') }}" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="{{ asset('css/soft-ui-dashboard.css?v=1.0.2') }}" rel="stylesheet" />
<style>
    main{
        margin: 0;
 ...
 <script src="{{ asset('js/core/popper.min.js') }}"></script>
  ...
  <script src="{{ asset('js/soft-ui-dashboard.min.js?v=1.0.2') }}"></script>
@endsection
            ...
            <div class="card card-plain mt-8">
              ...
              <div class="card-body">
                <form role="form text-left" method="POST" action="{{ route('login') }}">
                  ...
                  <input type="hidden" name="as" value="{{ $as ? $as : 'AM' }}">
